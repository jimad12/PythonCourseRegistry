...
class App:
  def __init__(self, master):
    ...
    #Course Applied For
    Label(master, text="Course Applied For:", wraplength=60).grid(row=4)
  ...
  def Eval(self):
    ...
    #check for Age
    if self.age < 21:
      tkMessageBox.showwarning("Invalid Age", "You are not eligible, you must be over 21")
      return
    ...
    if self.varl1 == "Quality Management (Adv.)":
      ...
      self.prereq = "The prereq for this cource is Financial Management (Bas)."
      self.flag = 1
